...
/* package haskell-servant-0.1.0.0 */
#ifndef VERSION_haskell_servant
#define VERSION_haskell_servant "0.1.0.0"
#endif /* VERSION_haskell_servant */
#ifndef MIN_VERSION_haskell_servant
#define MIN_VERSION_haskell_servant(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_servant */
...
#define CURRENT_PACKAGE_KEY "haskell-servant-0.1.0.0-JarIVP1gUJQ5KuQJ472lRy"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-servant-0.1.0.0-JarIVP1gUJQ5KuQJ472lRy"
